...
export class Reference extends Type {
     ...
     * @param { PropertyRegEx } getterPropertyRegEx PropertyRegEx
     * @param { PropertyRegEx } setterPropertyRegEx PropertyRegEx
     * @returns { Reference }
    */
    constructor(target, refId, getterPropertyRegEx, setterPropertyRegEx) {
        ...
        refValue = (refValue !== undefined) ? refValue : (target instanceof Class ? target : null);
